...
two_wheel_drive_vehicles_mpg <- vehicles[vehicles$drive == "2-Wheel Drive" & vehicles$cty > 20, ]

# Of the above vehicles, what is the vehicle ID of the vehicle with the worst 
# hwy mpg?
# Hint: filter for the worst vehicle, then select its ID.
worst_hwy_mpg <- two_wheel_drive_vehicles_mpg$id[two_wheel_drive_vehicles_mpg$hwy == min(two_wheel_drive_vehicles_mpg$hwy)]
